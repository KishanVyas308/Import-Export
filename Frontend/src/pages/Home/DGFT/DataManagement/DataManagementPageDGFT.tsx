      ...
      <div className="relative z-10">
        ...
        <div className="mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div className="relative">
              ...
              <div className="flex flex-wrap justify-between items-center p-6">
                <div className="flex items-center space-x-2">
                  ...
                  <Link to="/import-export/" className="flex items-center space-x-2 text-white/90 hover:text-white z-40 transition-colors cursor-pointer">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
            <DetailCard
              link="/import-export/dgft/datamanagement/newdata"
              title="New Data"
            ...
            <DetailCard
              link="/import-export/dgft/datamanagement/existingdata"
              title="Existing Data"
